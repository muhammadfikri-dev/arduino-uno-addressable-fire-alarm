# ⚡ Arduino Uno Addressable Fire Alarm Control Panel (FACP) Loop Poller
...
Class-A addressable fire alarm loop master polling up to 64 smoke/heat detector nodes over 2-wire signaling circuit with short-circuit isolator monitoring.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-addressable-fire-alarm.ino`](./arduino-uno-addressable-fire-alarm.ino).
