/**
 * =========================================================================================
 * Project     : Arduino Uno Addressable Fire Alarm Control Panel (FACP) Loop Poller
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Class-A addressable fire alarm loop master polling up to 64 smoke/heat detector nodes over 2-wire signaling circuit with short-circuit isolator monitoring.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Addressable Fire Alarm Control Panel (FACP) Loop Poller"));
